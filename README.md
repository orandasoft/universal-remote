...
A supported codeset is required for named receiver events and protocol-level decoded events. Without one, received signals are reported as `unknown` events with timing metadata.
